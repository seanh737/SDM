			...
			<div class="row offer-grids">
				<div class="col-lg-2 col-md-12">
					<div >
						...
						<a href="Gastroenterology.php" class="btn btn-banner mb-1" style="width: 137px; background:#67C9CE;">胃腸肝膽科</a>
						<a href="Cardiology.php" class="btn btn-banner mb-1" style="width: 137px;">心 臟 內 科</a>
