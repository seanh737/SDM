...
<section class="about py-5">
	<div class="layer">
		<h2 class="heading text-center mb-sm-5">SDM 簡介 </h2>
		<div class="row offer-grids">
			...
			<div class="col-lg-8 col-md-6 mt-md-0 mt-4">
				<div class="ser2">
					<div class="bg-layer">
						<h4 class="">緣起：</h4>
						<p class="mt-3">1982年　美國以病人為中心照護的共同福祉計畫上，為促進醫病相互尊重與溝通而提出。</p>
						<p>1997年　由Charles提出操作型定義：</p>
						<p>● 至少要有醫師和病人雙方共同參與。</p>
						<p>● 醫師提出各種不同處置之實證資料，病人則提出個人喜好與價值觀，彼此交換資訊並進行討論。</p>
						<p>● 醫病溝通討論後，共同達成最佳可行之治療選項。
						</p>
					</div>
				</div>
			</div>
		...
		<div class="row offer-grids">
			...
			<div class="col-lg-8 col-md-6 mt-md-0 mt-4">
				<div class="ser2">
					<div class="bg-layer">
						<h4 class="">簡介：</h4>
						<p class="mt-3">醫病共享決策(Shared Decision Making,SDM)其輔助工具是專門為病人所設計的工具，協助病人瞭解疾病、臨床進程、治療選擇的意義，及提出自己在意的考量及期待，利用圖形化的說明及互動式的工具，以最新的實證醫學證據，用病人能夠理解的方式做說明，為醫師及病人做出共同的醫療決策，藉以提升醫病溝通的效率。</p>
						<div class="row offer-grids">
						<div class="col-lg-4 col-md-6 mt-md-0 mt-4"></div>
						<div class="col-lg-4 col-md-6 mt-md-0 mt-4"></div>
						<div class="col-lg-4 col-md-6 mt-md-0 mt-4"><img src="images/info.png" class="img-fluid" alt="" style="height: 200px;"></div>
						</div>
		...
		<div class="row offer-grids">
			...
			<div class="col-lg-8 col-md-6 mt-md-0 mt-4">
				<div class="ser2">
					<div class="bg-layer">
						<h4 class="mt-3">步驟：</h4>
						<img src="images/tip.png" class="img-fluid" alt="">
						</div>
		...
		<div class="row offer-grids">
			...
			<div class="col-lg-8 col-md-6 mt-md-0 mt-4">
				<div class="ser2">
					<div class="bg-layer">
						<h4 class="">目的：</h4>
						<p class="mt-3">● 減輕醫療人員準備溝通資訊的負擔</p>
									 <p>● 幫助病人表達重要的好惡與價值觀</p>
									 <p>● 確認病人已瞭解做決定前應該具備的疾病或治療知識</p>
									 <p>● 降低病人決策前的焦慮</p>
								  	 <p>● 提升病人參與醫療決策</p>
									 <p>● 提升病人對醫療服務滿意度</p>
									 <p>● 增加病人對於醫療的順從度</p>
